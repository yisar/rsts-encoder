...
#### 前情提要：
何凯明团队发的一篇文章，使用meanflow算法，可以将原先的多步生成变为单步生成，极大地改变了当前 diffusion，flow matching 图像生成算法的性能现状
...
- 小组成员：赵昌浩（2025303120178）陈星灿（2025303110131）李世豪（2025303120170）李迁（2025303120110）
